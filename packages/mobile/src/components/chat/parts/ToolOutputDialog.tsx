				...
				>
						...
						<View style={styles.section}>
							...
							<View
								style={[
									styles.codeBlock,
									{
										backgroundColor: isDark ? 'rgba(28, 27, 26, 0.5)' : 'rgba(242, 240, 229, 0.5)',
					...
					{part.output && part.output.trim().length > 0 && (
						<View style={styles.section}>
							...
							>
								<Text style={[typography.code, { color: colors.foreground }]} selectable>
									{part.output}
								</Text>
							</View>
						</View>
					...
					{part.error && part.error.trim().length > 0 && (
						<View style={styles.section}>
							...
							>
								<Text style={[typography.code, { color: colors.destructive }]} selectable>
									{part.error}
								</Text>
							</View>
						</View>
