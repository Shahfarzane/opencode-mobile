    ...
    return (
        ...
        >
            ...
            {(canCopyMessage && hasCopyableText) || onRevert || onFork ? (
                <div className={cn(
                    "absolute -bottom-6 right-0 flex items-center justify-end gap-2 opacity-0 pointer-events-none transition-opacity duration-150 group-hover/message:opacity-100 group-hover/message:pointer-events-auto focus-within:opacity-100 focus-within:pointer-events-auto",
