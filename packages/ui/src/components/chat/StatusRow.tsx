...
export const StatusRow: React.FC<StatusRowProps> = ({
	...
	const todos = useTodoStore((state) =>
		currentSessionId
			? (state.sessionTodos.get(currentSessionId) ?? EMPTY_TODOS)
			: EMPTY_TODOS,
	);
	...
	const shouldRenderPlaceholder =
		!showAbortStatus && (wasAborted || !abortActive);

	// Track if placeholder is showing result (done/aborted) to keep StatusRow mounted
	const [placeholderShowingResult, setPlaceholderShowingResult] =
