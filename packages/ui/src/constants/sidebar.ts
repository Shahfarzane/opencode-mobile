...
export const SIDEBAR_SECTIONS: SidebarSectionConfig[] = [
	{
		...
		label: "Sessions",
		description:
			"Browse and manage chat sessions scoped to the current directory.",
		icon: RiChatAi3Line,
	},
	{
		id: "agents",
	...
	},
	{
		...
		label: "Skills",
		description:
			"Create reusable instruction files for agents to load on-demand.",
		icon: RiBookLine,
	},
	{
		id: "providers",
...
const sidebarSectionConfigMap = {} as Record<
	SidebarSection,
